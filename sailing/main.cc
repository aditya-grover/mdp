...
int main(int argc, const char **argv) {
    ...
    //<< "\nproblem="<<problem
     //for( std::vector<pair<const Online::Policy::policy_t<state_t>*, string> >::const_iterator i = bases.begin(); i != bases.end(); ++i)
   //std::cout << *i << ' ';
   // cout<<" base_name="<<base_name<<" policy_type="<<policy_type<<" bases="<<std::get<1>(bases.at(2))<<" eval_pars="<<eval_pars<<endl;
